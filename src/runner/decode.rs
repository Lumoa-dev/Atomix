...
use crate::base::isa::{self, EncTemplate};
...
pub fn dispatch_table() -> Vec<OpcodeEntry> {
    ...
    let entries: &[(u8, &str, EncTemplate)] = &[
        (0x00, "NOP", EncTemplate::JI),
        (0x01, "TRAP", EncTemplate::R1I),
        (0x02, "THROW", EncTemplate::R1I),
        (0x10, "MOV", EncTemplate::R3),
        (0x11, "MOVI", EncTemplate::R2I),
        (0x12, "LCONST", EncTemplate::R1I),
        (0x13, "LOAD", EncTemplate::R2I),
        (0x14, "STORE", EncTemplate::R2I),
        (0x20, "ADD", EncTemplate::R3),
        (0x21, "ADDI", EncTemplate::R2I),
        (0x22, "SUB", EncTemplate::R3),
        (0x23, "MUL", EncTemplate::R3),
        (0x24, "DIV", EncTemplate::R3),
        (0x25, "DIVU", EncTemplate::R3),
        (0x26, "REM", EncTemplate::R3),
        (0x27, "AND", EncTemplate::R3),
        (0x28, "OR", EncTemplate::R3),
        (0x29, "XOR", EncTemplate::R3),
        (0x2A, "NOT", EncTemplate::R1I),
        (0x2B, "NEG", EncTemplate::R1I),
        (0x2C, "SHL", EncTemplate::R3),
        (0x2D, "SHR", EncTemplate::R3),
        (0x2E, "SHRU", EncTemplate::R3),
        (0x2F, "FADD", EncTemplate::R3),
        (0x30, "FSUB", EncTemplate::R3),
        (0x31, "FMUL", EncTemplate::R3),
        (0x32, "FDIV", EncTemplate::R3),
        (0x33, "FEQ", EncTemplate::R3),
        (0x34, "FNE", EncTemplate::R3),
        (0x35, "FLT", EncTemplate::R3),
        (0x36, "FLE", EncTemplate::R3),
        (0x37, "ITOF", EncTemplate::R1I),
        (0x38, "FTOI", EncTemplate::R1I),
        (0x40, "SEQ", EncTemplate::R3),
        (0x41, "SNE", EncTemplate::R3),
        (0x42, "SLT", EncTemplate::R3),
        (0x43, "SLE", EncTemplate::R3),
        (0x44, "SGT", EncTemplate::R3),
        (0x45, "SGE", EncTemplate::R3),
        (0x50, "JMP", EncTemplate::JI),
        (0x51, "JZ", EncTemplate::R1I),
        (0x52, "JNZ", EncTemplate::R1I),
        (0x53, "CALL", EncTemplate::JI),
        (0x54, "JMPR", EncTemplate::R1I),
        (0x55, "JALR", EncTemplate::R2I),
        (0x60, "TASK_FORK", EncTemplate::R1I),
        (0x61, "TASK_JOIN", EncTemplate::R2I),
        (0x62, "TASK_RET", EncTemplate::R1I),
        (0x63, "TASK_SELF", EncTemplate::R1I),
        (0x70, "ECALL", EncTemplate::R1I),
        (0x80, "MCPY", EncTemplate::R3),
        (0x81, "MSET", EncTemplate::R3),
        (0xF0, "FENCE", EncTemplate::R1I),
        (0xF1, "CAS", EncTemplate::R3),
    ];
